"""
Django settings for portfolio contact backend.

Production-ready configuration with DRF, JWT, Celery, and CORS.
"""
import os
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/hour',
        'user': '1000/hour',
        'contact': '10/hour',  # Custom rate for contact endpoint
    },
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@scalifylabs.com')
